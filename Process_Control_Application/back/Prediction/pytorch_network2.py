...
def main():
    ...
    with torch.no_grad():
        ...
        predictions_unscaled = scaler_labels.inverse_transform(predictions.numpy())
        predictions_mean = predictions_unscaled.mean(0).tolist()
        #predictions_mean = [round(p, 2) for p in predictions_mean]
